# -*- coding: utf-8 -*-
"""
Created on Wed Nov  5 22:03:25 2025
...
for shop_id in shop_ids:
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            # Extract price and sold quantity safely
            try:
        ...
        df.loc[idx, 'sold_qty'] = sold_qty
        df.loc[idx, 'product_revenue'] = product_revenue
    ...
    print(f"💰 Total revenue for shop {shop_id}: {total_revenue:,.0f} IDR")

    # Optionally, save each shop’s detailed product data
    output_file = f"products_{shop_id}.csv"
    df.to_csv(output_file, index=False, encoding='utf-8-sig')
    print(f"✅ Saved product data to {output_file}")

    time.sleep(2)  # delay between shops
